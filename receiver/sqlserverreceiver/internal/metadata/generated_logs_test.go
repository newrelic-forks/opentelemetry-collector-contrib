		...
		t.Run(tt.name, func(t *testing.T) {
			...
			for i := 0; i < lrs.Len(); i++ {
				...
				case "db.server.query_sample":
					...
					attrVal, ok = lr.Attributes().Get("db.sql.comments")
					assert.True(t, ok)
					assert.Equal(t, "db.sql.comments-val", attrVal.Str())
