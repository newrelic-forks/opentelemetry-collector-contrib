...
func (e *eventDbServerQuerySample) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, clientAddressAttributeValue string, clientPortAttributeValue int64, dbNamespaceAttributeValue string, dbQueryTextAttributeValue string, dbSystemNameAttributeValue string, networkPeerAddressAttributeValue string, networkPeerPortAttributeValue int64, sqlserverBlockingSessionIDAttributeValue int64, sqlserverBlockingStartTimeAttributeValue string, sqlserverContextInfoAttributeValue string, sqlserverCommandAttributeValue string, sqlserverCPUTimeAttributeValue float64, sqlserverDeadlockPriorityAttributeValue int64, sqlserverEstimatedCompletionTimeAttributeValue float64, sqlserverHostProcessIDAttributeValue int64, sqlserverLockTimeoutAttributeValue float64, sqlserverLogicalReadsAttributeValue int64, sqlserverOpenTransactionCountAttributeValue int64, sqlserverPercentCompleteAttributeValue float64, sqlserverQueryHashAttributeValue string, sqlserverQueryPlanHashAttributeValue string, sqlserverQueryStartAttributeValue string, sqlserverReadsAttributeValue int64, sqlserverRequestStatusAttributeValue string, sqlserverWaitResourceIDAttributeValue string, sqlserverWaitResourceTypeAttributeValue string, sqlserverRowCountAttributeValue int64, sqlserverSessionElapsedTimeAttributeValue float64, sqlserverSessionIDAttributeValue int64, sqlserverSessionLoginTimeAttributeValue string, sqlserverSessionProgramNameAttributeValue string, sqlserverSessionStatusAttributeValue string, sqlserverTotalElapsedTimeAttributeValue float64, sqlserverTransactionIDAttributeValue int64, sqlserverTransactionIsolationLevelAttributeValue int64, sqlserverWaitResourceAttributeValue string, sqlserverWaitTimeAttributeValue float64, sqlserverWaitTypeAttributeValue string, sqlserverWritesAttributeValue int64, userNameAttributeValue string, sqlserverProcedureIDAttributeValue string, sqlserverProcedureNameAttributeValue string) {
	...
	dp.Attributes().PutInt("sqlserver.host_process_id", sqlserverHostProcessIDAttributeValue)
	...
	dp.Attributes().PutDouble("sqlserver.session_elapsed_time", sqlserverSessionElapsedTimeAttributeValue)
	dp.Attributes().PutInt("sqlserver.session_id", sqlserverSessionIDAttributeValue)
	dp.Attributes().PutStr("sqlserver.session_login_time", sqlserverSessionLoginTimeAttributeValue)
	dp.Attributes().PutStr("sqlserver.session_program_name", sqlserverSessionProgramNameAttributeValue)
