...
require (
	...
	github.com/newrelic-forks/opentelemetry-collector-contrib/internal/nrcommon v0.154.4
	github.com/newrelic-forks/opentelemetry-collector-contrib/internal/nrsqlquery v0.154.4
