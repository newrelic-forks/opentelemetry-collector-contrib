...
func TestLogsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			allEventsCount++
			lb.RecordDbServerQueryPlanEvent(ctx, timestamp, "sqlserver.avg_row_size-val", "sqlserver.estimate_cpu-val", "sqlserver.estimate_io-val", "sqlserver.estimate_rows-val", "sqlserver.estimated_execution_mode-val", "sqlserver.estimated_total_subtree_cost-val", "sqlserver.index_name-val", AttributeSqlserverInputTypeRoot, "sqlserver.logical_op-val", 17, 24, "sqlserver.physical_op-val", "sqlserver.query_plan_hash-val", "sqlserver.schema_name-val", "sqlserver.table_name-val")
			...
			for i := 0; i < lrs.Len(); i++ {
				...
				case "db.server.query_plan":
					...
					attrVal, ok := lr.Attributes().Get("sqlserver.avg_row_size")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.avg_row_size-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.estimate_cpu")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.estimate_cpu-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.estimate_io")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.estimate_io-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.estimate_rows")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.estimate_rows-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.estimated_execution_mode")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.estimated_execution_mode-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.estimated_total_subtree_cost")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.estimated_total_subtree_cost-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.index_name")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.index_name-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.input_type")
					assert.True(t, ok)
					assert.Equal(t, "Root", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.logical_op")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.logical_op-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.node_id")
					assert.True(t, ok)
					assert.EqualValues(t, 17, attrVal.Int())
					attrVal, ok = lr.Attributes().Get("sqlserver.parent_node_id")
					assert.True(t, ok)
					assert.EqualValues(t, 24, attrVal.Int())
					attrVal, ok = lr.Attributes().Get("sqlserver.physical_op")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.physical_op-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.query_plan_hash")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.query_plan_hash-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.schema_name")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.schema_name-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("sqlserver.table_name")
					assert.True(t, ok)
					assert.Equal(t, "sqlserver.table_name-val", attrVal.Str())
