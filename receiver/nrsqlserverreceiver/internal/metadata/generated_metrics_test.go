...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			allMetricsCount++
			mb.RecordSqlserverTaskCountDataPoint(ts, 1, AttributeTaskStateCurrent)
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverTaskCountDataPoint(ts, 3, AttributeTaskStateQueued)
			}
			...
			allMetricsCount++
			mb.RecordSqlserverWorkerThreadCountDataPoint(ts, 1, AttributeWorkerStateRunning)
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverWorkerThreadCountDataPoint(ts, 3, AttributeWorkerStateSuspendedOrSleeping)
			}
