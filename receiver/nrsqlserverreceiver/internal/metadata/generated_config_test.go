		...
		},
		{
			...
			want: MetricsBuilderConfig{
				...
				ResourceAttributes: ResourceAttributesConfig{
					...
					SqlserverVersion:      SqlserverVersionResourceAttributeConfig{Enabled: true},
				},
			},
		},
		{
			...
			want: MetricsBuilderConfig{
				...
				ResourceAttributes: ResourceAttributesConfig{
					...
					SqlserverVersion:      SqlserverVersionResourceAttributeConfig{Enabled: false},
				},
			},
		},
	}
...
func TestResourceAttributesOverrideConfig(t *testing.T) {
	...
	assert.NotNil(t, cfg.SqlserverVersion.OverrideValue, "override_value should be set for sqlserver.version")
}
