...
// SqlserverVersionResourceAttributeConfig provides config for the sqlserver.version resource attribute.
type SqlserverVersionResourceAttributeConfig struct {
	Enabled bool `mapstructure:"enabled"`
	// OverrideValue allows users to override the value of this resource attribute.
	OverrideValue *string `mapstructure:"override_value"`
	// Experimental: MetricsInclude defines a list of filters for attribute values.
...
func (rac *SqlserverVersionResourceAttributeConfig) Unmarshal(parser *confmap.Conf) error {
	if parser == nil {
		return nil
	}
	err := parser.Unmarshal(rac)
...
type ResourceAttributesConfig struct {
	...
	SqlserverVersion      SqlserverVersionResourceAttributeConfig      `mapstructure:"sqlserver.version"`
}
...
func DefaultResourceAttributesConfig() ResourceAttributesConfig {
	return ResourceAttributesConfig{
		...
		SqlserverVersion: SqlserverVersionResourceAttributeConfig{
			Enabled: true,
		},
	}
}
...
func (rac *ResourceAttributesConfig) applyOverrideValues(res pcommon.Resource) {
	...
	if rac.SqlserverVersion.Enabled && rac.SqlserverVersion.OverrideValue != nil {
		res.Attributes().PutStr("sqlserver.version", *rac.SqlserverVersion.OverrideValue)
	}
}
