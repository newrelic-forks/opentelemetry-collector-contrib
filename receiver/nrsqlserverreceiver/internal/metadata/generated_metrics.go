...
func NewMetricsBuilder(mbc MetricsBuilderConfig, settings receiver.Settings, options ...MetricBuilderOption) *MetricsBuilder {
	...
	if mbc.ResourceAttributes.SqlserverTargetHost.MetricsInclude != nil {
		mb.resourceAttributeIncludeFilter["sqlserver.target.host"] = filter.CreateFilter(mbc.ResourceAttributes.SqlserverTargetHost.MetricsInclude)
	}
	if mbc.ResourceAttributes.SqlserverTargetHost.MetricsExclude != nil {
		mb.resourceAttributeExcludeFilter["sqlserver.target.host"] = filter.CreateFilter(mbc.ResourceAttributes.SqlserverTargetHost.MetricsExclude)
	}
