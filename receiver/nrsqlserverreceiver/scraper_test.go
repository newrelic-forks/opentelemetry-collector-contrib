...
func configureAllScraperMetricsAndEvents(cfg *Config, enabled bool) {
	...
	cfg.Events.DbServerQueryPlan.Enabled = enabled
...
func TestSuccessfulScrape(t *testing.T) {
	...
	for _, scraper := range scrapers {
		...
		case getSQLServerDatabaseSizeQuery(scraper.config.InstanceName):
			expectedFile = filepath.Join("testdata", "expectedDatabaseSize.yaml")
...
func TestQueryTextAndPlanQueryDbServerQueryPlanEvent(t *testing.T) {
	...
	configureAllScraperMetricsAndEvents(cfg, false)
	cfg.Events.DbServerTopQuery.Enabled = true
	cfg.Events.DbServerQueryPlan.Enabled = true
	cfg.TopQueryCollection.CollectionInterval = cfg.CollectionInterval
...
func TestQueryTextAndPlanQueryDbServerQueryPlanEventDisabled(t *testing.T) {
	...
	configureAllScraperMetricsAndEvents(cfg, false)
	cfg.Events.DbServerTopQuery.Enabled = true
	cfg.Events.DbServerQueryPlan.Enabled = false
	cfg.TopQueryCollection.CollectionInterval = cfg.CollectionInterval
