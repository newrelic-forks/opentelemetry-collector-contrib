...
func TestLogsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			allEventsCount++
			lb.RecordDbServerProcedureMetricsEvent(ctx, timestamp, "db.system.name-val", "db.namespace-val", "db.server.name-val", "oracle.db.service-val", 21, "oracledb.procedure_name-val", "oracledb.procedure_type-val", "oracledb.procedure.schema_name-val", 34, 17.100000, 21.100000, 35.100000, 20, 19, 22, 23, 28, 29, "oracledb.procedure.first_load_time-val", "oracledb.procedure.last_active_time-val")

			allEventsCount++
			lb.RecordDbServerQuerySampleEvent(ctx, timestamp, "db.query.text-val", "db.system.name-val", "user.name-val", "db.namespace-val", "oracle.db.service-val", "client.address-val", 11, "network.peer.address-val", 17, "oracledb.plan_hash_value-val", "oracledb.sql_id-val", "oracledb.child_number-val", "oracledb.child_address-val", "oracledb.sid-val", "oracledb.serial-val", "oracledb.process-val", "oracledb.schemaname-val", "oracledb.program-val", "oracledb.module-val", "oracledb.status-val", "oracledb.state-val", "oracledb.wait_class-val", "oracledb.event-val", 24.100000, 21, "oracledb.procedure_name-val", "oracledb.procedure_type-val", "oracledb.osuser-val", 21.100000, "db.query.comment_tags-val", "query.comments-val", "db.query.comment_tags.nr_service_guid-val", "query.comments.nr_service_guid-val", "oracledb.query.started-val", "oracledb.session.started-val", 25.100000, "oracledb.blocking.blocker.sid-val", "oracledb.blocking.blocker.root_sid-val", "oracledb.blocking.blocker.state-val", "oracledb.blocking.start_time-val", 31, "oracledb.blocking.lock.mode-val", "oracledb.blocking.lock.type-val", "oracledb.blocking.object.owner-val", "oracledb.blocking.object.name-val", "db.query.text.normalized.hash-val", "oracledb.normalised_sql_hash-val")
			...
			allEventsCount++
			lb.RecordDbServerTopQueryEvent(ctx, timestamp, "db.system.name-val", "db.server.name-val", "db.namespace-val", "oracle.db.service-val", "db.query.text-val", "oracledb.query_plan-val", "oracledb.sql_id-val", "oracledb.child_number-val", "oracledb.child_address-val", 30.100000, 20, 26.100000, 21, 30.100000, 17.100000, 21, 22, 19, 21.100000, 19, 28, 31, 29, 32, 23, 26.100000, 34, 21, "oracledb.procedure_name-val", "oracledb.procedure_type-val", "db.query.comment_tags-val", "query.comments-val", "db.query.comment_tags.nr_service_guid-val", "query.comments.nr_service_guid-val", "oracledb.plan_hash_value-val", "oracledb.plan.first_load-val", "oracledb.plan.last_load-val", "db.query.text.normalized.hash-val", "oracledb.normalised_sql_hash-val")
			...
			for i := 0; i < lrs.Len(); i++ {
				...
				case "db.server.procedure_metrics":
					...
					attrVal, ok = lr.Attributes().Get("oracledb.procedure.avg_elapsed_time")
					assert.True(t, ok)
					...
					attrVal, ok = lr.Attributes().Get("oracledb.procedure.first_load_time")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.procedure.first_load_time-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.procedure.last_active_time")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.procedure.last_active_time-val", attrVal.Str())
				...
				case "db.server.session.wait_sample":
					...
					assert.True(t, ok)
					assert.EqualValues(t, 19, attrVal.Int())
					attrVal, ok = lr.Attributes().Get("oracledb.wait.timeouts")
					assert.True(t, ok)
					assert.EqualValues(t, 22, attrVal.Int())
				...
				case "db.server.top_query":
					...
					assert.True(t, ok)
					assert.Equal(t, "oracledb.normalised_sql_hash-val", attrVal.Str())
				case "db.server.wait_chain":
					assert.False(t, validatedEvents["db.server.wait_chain"], "Found a duplicate in the events slice: db.server.wait_chain")
					validatedEvents["db.server.wait_chain"] = true
					lr := lrs.At(i)
					assert.Equal(t, timestamp, lr.Timestamp())
					assert.Equal(t, pcommon.TraceID(traceID), lr.TraceID())
					assert.Equal(t, pcommon.SpanID(spanID), lr.SpanID())
					...
					assert.True(t, ok)
					assert.Equal(t, "oracledb.event-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.chain_id")
					assert.True(t, ok)
					assert.EqualValues(t, 17, attrVal.Int())
					attrVal, ok = lr.Attributes().Get("oracledb.chain_is_cycle")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.chain_is_cycle-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.in_wait")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.in_wait-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.blocking.wait_duration")
					assert.True(t, ok)
					assert.EqualValues(t, 31, attrVal.Int())
					attrVal, ok = lr.Attributes().Get("oracledb.num_waiters")
					assert.True(t, ok)
					assert.EqualValues(t, 20, attrVal.Int())
					attrVal, ok = lr.Attributes().Get("oracledb.locked_object_id")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.locked_object_id-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.blocking.instance")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.blocking.instance-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.blocking.blocker.sid")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.blocking.blocker.sid-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.blocking.serial")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.blocking.serial-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.blocking.pdb_name")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.blocking.pdb_name-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.is_root_blocker")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.is_root_blocker-val", attrVal.Str())
					attrVal, ok = lr.Attributes().Get("oracledb.blocking_scope")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.blocking_scope-val", attrVal.Str())
				}
			}
		})
	}
