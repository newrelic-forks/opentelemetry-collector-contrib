...
func (e *eventDbServerProcedureMetrics) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, dbSystemNameAttributeValue string, dbNamespaceAttributeValue string, dbServerNameAttributeValue string, oracleDbServiceAttributeValue string, oracledbProcedureIDAttributeValue int64, oracledbProcedureNameAttributeValue string, oracledbProcedureTypeAttributeValue string, oracledbProcedureSchemaNameAttributeValue string, oracledbProcedureExecutionCountAttributeValue int64, oracledbCPUTimeAttributeValue float64, oracledbElapsedTimeAttributeValue float64, oracledbProcedureAvgElapsedTimeAttributeValue float64, oracledbBufferGetsAttributeValue int64, oracledbDiskReadsAttributeValue int64, oracledbDirectWritesAttributeValue int64, oracledbRowsProcessedAttributeValue int64, oracledbPhysicalReadBytesAttributeValue int64, oracledbPhysicalWriteBytesAttributeValue int64, oracledbProcedureFirstLoadTimeAttributeValue string, oracledbProcedureLastActiveTimeAttributeValue string) {
	...
	dp.Attributes().PutDouble("oracledb.procedure.avg_elapsed_time", oracledbProcedureAvgElapsedTimeAttributeValue)
...
func (e *eventDbServerQuerySample) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, dbQueryTextAttributeValue string, dbSystemNameAttributeValue string, userNameAttributeValue string, dbNamespaceAttributeValue string, oracleDbServiceAttributeValue string, clientAddressAttributeValue string, clientPortAttributeValue int64, networkPeerAddressAttributeValue string, networkPeerPortAttributeValue int64, oracledbPlanHashValueAttributeValue string, oracledbSQLIDAttributeValue string, oracledbChildNumberAttributeValue string, oracledbChildAddressAttributeValue string, oracledbSidAttributeValue string, oracledbSerialAttributeValue string, oracledbProcessAttributeValue string, oracledbSchemanameAttributeValue string, oracledbProgramAttributeValue string, oracledbModuleAttributeValue string, oracledbStatusAttributeValue string, oracledbStateAttributeValue string, oracledbWaitClassAttributeValue string, oracledbEventAttributeValue string, oracledbQueryWaitTimeAttributeValue float64, oracledbProcedureIDAttributeValue int64, oracledbProcedureNameAttributeValue string, oracledbProcedureTypeAttributeValue string, oracledbOsuserAttributeValue string, oracledbDurationSecAttributeValue float64, dbQueryCommentTagsAttributeValue string, queryCommentsAttributeValue string, dbQueryCommentTagsNrServiceGUIDAttributeValue string, queryCommentsNrServiceGUIDAttributeValue string, oracledbQueryStartedAttributeValue string, oracledbSessionStartedAttributeValue string, oracledbSessionDurationAttributeValue float64, oracledbBlockingBlockerSidAttributeValue string, oracledbBlockingBlockerRootSidAttributeValue string, oracledbBlockingBlockerStateAttributeValue string, oracledbBlockingStartTimeAttributeValue string, oracledbBlockingWaitDurationAttributeValue int64, oracledbBlockingLockModeAttributeValue string, oracledbBlockingLockTypeAttributeValue string, oracledbBlockingObjectOwnerAttributeValue string, oracledbBlockingObjectNameAttributeValue string, dbQueryTextNormalizedHashAttributeValue string, oracledbNormalisedSQLHashAttributeValue string) {
	...
	dp.Attributes().PutStr("query.comments.nr_service_guid", queryCommentsNrServiceGUIDAttributeValue)
	...
	dp.Attributes().PutStr("oracledb.normalised_sql_hash", oracledbNormalisedSQLHashAttributeValue)
...
type eventDbServerWaitChain struct {
	data   plog.LogRecordSlice // data buffer for generated log records.
	config EventConfig         // event config provided by user.
}

func (e *eventDbServerWaitChain) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, dbNamespaceAttributeValue string, oracledbSidAttributeValue string, oracledbSerialAttributeValue string, oracledbEventAttributeValue string, oracledbChainIDAttributeValue int64, oracledbChainIsCycleAttributeValue string, oracledbInWaitAttributeValue string, oracledbBlockingWaitDurationAttributeValue int64, oracledbNumWaitersAttributeValue int64, oracledbLockedObjectIDAttributeValue string, oracledbBlockingInstanceAttributeValue string, oracledbBlockingBlockerSidAttributeValue string, oracledbBlockingSerialAttributeValue string, oracledbBlockingPdbNameAttributeValue string, oracledbIsRootBlockerAttributeValue string, oracledbBlockingScopeAttributeValue string) {
	if !e.config.Enabled {
		return
	}
	dp := e.data.AppendEmpty()
	dp.SetEventName("db.server.wait_chain")
	dp.SetTimestamp(timestamp)
	...
	dp.Attributes().PutStr("oracledb.serial", oracledbSerialAttributeValue)
	dp.Attributes().PutStr("oracledb.event", oracledbEventAttributeValue)
	dp.Attributes().PutInt("oracledb.chain_id", oracledbChainIDAttributeValue)
	dp.Attributes().PutStr("oracledb.chain_is_cycle", oracledbChainIsCycleAttributeValue)
	dp.Attributes().PutStr("oracledb.in_wait", oracledbInWaitAttributeValue)
	dp.Attributes().PutInt("oracledb.blocking.wait_duration", oracledbBlockingWaitDurationAttributeValue)
	dp.Attributes().PutInt("oracledb.num_waiters", oracledbNumWaitersAttributeValue)
	dp.Attributes().PutStr("oracledb.locked_object_id", oracledbLockedObjectIDAttributeValue)
	dp.Attributes().PutStr("oracledb.blocking.instance", oracledbBlockingInstanceAttributeValue)
	dp.Attributes().PutStr("oracledb.blocking.blocker.sid", oracledbBlockingBlockerSidAttributeValue)
	dp.Attributes().PutStr("oracledb.blocking.serial", oracledbBlockingSerialAttributeValue)
	dp.Attributes().PutStr("oracledb.blocking.pdb_name", oracledbBlockingPdbNameAttributeValue)
	dp.Attributes().PutStr("oracledb.is_root_blocker", oracledbIsRootBlockerAttributeValue)
	dp.Attributes().PutStr("oracledb.blocking_scope", oracledbBlockingScopeAttributeValue)

}

// emit appends recorded event data to a events slice and prepares it for recording another set of log records.
func (e *eventDbServerWaitChain) emit(lrs plog.LogRecordSlice) {
	if e.config.Enabled && e.data.Len() > 0 {
		e.data.MoveAndAppendTo(lrs)
	}
}

func newEventDbServerWaitChain(cfg EventConfig) eventDbServerWaitChain {
	e := eventDbServerWaitChain{config: cfg}
	if cfg.Enabled {
		e.data = plog.NewLogRecordSlice()
	}
	return e
...
type LogsBuilder struct {
	...
	eventDbServerWaitChain         eventDbServerWaitChain
}
...
func NewLogsBuilder(lbc LogsBuilderConfig, settings receiver.Settings) *LogsBuilder {
	lb := &LogsBuilder{
		...
		eventDbServerWaitChain:         newEventDbServerWaitChain(lbc.Events.DbServerWaitChain),
...
func (lb *LogsBuilder) EmitForResource(options ...ResourceLogsOption) {
	...
	lb.eventDbServerWaitChain.emit(ils.LogRecords())
