...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/common/sqlcomments v0.152.0
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/internal/common/sqlcomments => ../../internal/common/sqlcomments
